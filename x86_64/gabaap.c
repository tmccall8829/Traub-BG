...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 3;
 	...
 	ivoc_help("help ?1 GABAa_S /Users/tom/Computational-Neuroscience-Research/Traub-BG/x86_64/gabaap.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 110 in file gabaap.mod:\n	SOLVE release\n"); nrn_complain(_p); abort_run(error);}
